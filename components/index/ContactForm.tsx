...
function ContactForm() {
    return (
        <section className="h-fit bg-white grid md:grid-cols-2 lg:gap-12 lg:my-20 my-10 gap-8 w-full px-4 py-8 lg:p-16 rounded-md">
            ...
            <div className="flex-col justify-start items-start gap-6 inline-flex my-auto px-4 lg:px-16">
                ...
                <div className="rounded-2xl justify-start items-center gap-4 inline-flex">
                    <Mail color="#BC201B" />
                    <p className="text-black text-xl font-medium font-roboto underline">info@pmot.nl</p>
                </div>
                ...
                <div className="rounded-2xl border -ml-4 md:-ml-6 border-secondary justify-start items-center gap-4 px-4 py-1 md:px-6 md:py-3 flex">
                    <Phone color="#BC201B" />
                    <p className="text-blacktext-xl font-medium font-roboto"> +31 (0)597 591596</p>
                </div>

                <div className="rounded-2xl justify-start items-center gap-4 inline-flex">
                    <MapPin color="#BC201B" />
                    <p className="text-blacktext-xl font-medium font-['Poppins']">Torenstraat 13 9679 BN Scheemda</p>
                </div>
