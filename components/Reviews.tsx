            ...
            <div className="p-1">
              <Card>
                ...
                <div className="my-4 text-center">
                    ...
                    <p className="text-gray-500 text-xs mt-1">{review.attributes.Date}</p>
                    <div className="flex py-4">{renderStars(review.attributes.stars)}</div>

                  </div>
                  <p className="text-center text-wrap line-clamp-[8]">&quot;{review.attributes.review}&quot;</p>
                </CardContent>
              </Card>
            </div>
          </CarouselItem>
